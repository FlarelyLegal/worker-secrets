...
class VaultClient {
  ...
  registerToken(clientId: string, name: string, opts?: { description?: string; scopes?: string; role?: string; client_secret_hash?: string; age_public_key?: string }): Promise<{ ok: boolean; client_id: string }>
